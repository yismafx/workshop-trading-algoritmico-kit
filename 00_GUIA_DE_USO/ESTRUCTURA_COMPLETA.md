...
\*\*Metodología:\*\* Código ya funcionando que adaptas con GenAI
...
\- \*\*Entregable:\*\* Script `data\_pipeline.py` adaptado + Dataset limpio
...
\- \*\*Entregable:\*\* Función `get\_position\_size()` configurada + Playbook
...
\## Balance Teoría-Práctica por Semana



| Semana | Teoría | Práctica | Enfoque |

|--------|--------|----------|---------|

| \*\*Semana 1\*\* | 50% | 50% | Fundamentos + Setup |

| \*\*Semana 2\*\* | 30% | 70% | Código + Validación |

| \*\*Semana 3\*\* | 35% | 65% | Deployment + Docs |
...
\- Te damos código ya funcionando

\- Aprendes a adaptar con GenAI como copiloto

\- Enfoque: Usuario avanzado de sistemas, no desarrollador



\*\*Herramientas que recibes:\*\*

\- ✅ Colab Notebook Maestro (código completo ejecutable)

\- ✅ Template Pack Profesional (documentación institucional)

\- ✅ Prompts Library (35+ prompts probados)
