...
🏠 [Inicio](../README.md) > 📂 [Guía de Uso](GUIA_INICIO.md) > 📄 **Librerías Mínimas vs Completas**
...
**Usa Google Colab** → [Setup_Colab_Rapido.md](Setup_Colab_Rapido.md)
...
1. **Empieza con Colab:** [Setup_Colab_Rapido.md](Setup_Colab_Rapido.md)
