...
**📘 [Ver Template](https://github.com/yismafx/workshop-trading-algoritmico-kit/blob/main/02_TEMPLATE_PACK/Strategy_Memo_Template.md)**
...
**📘 [Ver Template](https://github.com/yismafx/workshop-trading-algoritmico-kit/blob/main/02_TEMPLATE_PACK/Backtesting_Report_Template.md)**
...
**📘 [Ver Template](https://github.com/yismafx/workshop-trading-algoritmico-kit/blob/main/02_TEMPLATE_PACK/README_Tecnico_Template.md)**
...
**📘 [Ver Template](https://github.com/yismafx/workshop-trading-algoritmico-kit/blob/main/02_TEMPLATE_PACK/Risk_Management_Plan_Template.md)**
...
**📘 [Ir a Setup A](Setup_Colab_Rapido.md)**
...
- 🔑 [Setup Broker Alpaca](Setup_A_Broker_Alpaca.md)
- 🏦 [Setup Broker IB](Setup_A_Broker_IB.md)
- ✅ [Mejores Prácticas](Mejores_Practicas_Setup_A.md)
- 🚨 [Troubleshooting Completo](Troubleshooting_Setup_A.md)
...
**Por Setup:**
- 🚨 [Troubleshooting Setup A (Colab)](Troubleshooting_Setup_A.md) - 50+ errores
...
**Para Principiantes:**
1. Empieza con [Setup A (Colab)](Setup_Colab_Rapido.md)
