...
#### Videos de Google Colab (2024-2025):

**En Español:**
- 🎥 [Google Colab: Tutorial Completo](https://www.youtube.com/watch?v=HW29067qVWk) (Platzi, 15 min)
- 📖 [Guía Completa Google Colab](https://dialektico.com/google-colab/) (Tutorial escrito actualizado 2025)
- 📖 [Google Colab para Principiantes](https://neoland.es/google-colab/) (Artículo 2025)

**En Inglés:**
- 🎥 [Google Colab - Guía Oficial](https://www.youtube.com/watch?v=inN8seMm7UI) (Google, 10 min)

#### Videos de APIs de Trading (2024-2025):

**Alpaca API:**
- 🎥 [Alpaca API - Canal Oficial YouTube](https://www.youtube.com/@AlpacaHQ) (Tutoriales oficiales)
- 📖 [Alpaca API - Documentación Learn](https://alpaca.markets/learn) (Guías y tutoriales oficiales)
- 📖 [Programando órdenes con Alpaca en Python](https://medium.com/datons-stories-es/programar-%C3%B3rdendes-de-trading-con-la-api-de-alpaca-en-python-bbfb4d447bb4) (Tutorial español 2024)
- 📖 [Trading Bot con Alpaca API](https://www.toolify.ai/es/ai-news-es/construye-un-bot-de-trading-con-la-api-de-alpaca-y-python-3602340) (Guía paso a paso 2024)

**Interactive Brokers API:**
- 🎥 [IB API - Tutoriales Oficiales](https://www.youtube.com/results?search_query=interactive+brokers+api+python+2024) (Buscar más recientes)
- 📖 [IB API Documentation](https://interactivebrokers.github.io/tws-api/) (Documentación oficial)

**Trading Algorítmico General:**
- 📖 [AlgoTrading101 - Alpaca Guide](https://algotrading101.com/learn/alpaca-trading-api-guide/) (Guía completa)
